...
# Executing oh-my-posh on startup
...
bash $HOME/scripts/set-audio-profiles

# Audio changing aliases
alias tv-audio="~/scripts/tv-audio"
alias mic-audio="~/scripts/mic-audio"

# Binding ctrl+f to run the following script
bind -x '"\C-f":"~/scripts/tmux"'

# Binding ctrl+n so we can open files on neovim using fzf
bind -x '"\C-n":"nvim $(fzf)"'

# Binding ranger to ctrl+o
bind -x '"\C-o":"ranger"'
